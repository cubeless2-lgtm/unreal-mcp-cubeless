...
def info():
    ...
    - `sample_anim_node_pre_post_runtime_pose(blueprint_name="", node_id="", node_type="", dry_run=True)` - Resolve an AnimGraph node target or run active-component/isolated-temp pose probes
