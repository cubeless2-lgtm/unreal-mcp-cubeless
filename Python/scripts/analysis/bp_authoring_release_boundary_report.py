...
REPORT_SCHEMA = "section_152_bp_authoring_release_boundary_v94"
...
def build_report(repo_root: Optional[Path] = None, project_root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    preliminary_verdict = {
        "status": "passed",
        "release_boundary_version": "section_152_v94",
        "durable_authoring_enabled": False,
    }
    ...
    return {
        ...
        "next_reinforcement_candidates": [
            "durable executor authoring final no-save release contract only after durable executor authoring command result readback-after-result-after-application-after-decision-after-evidence-after-execution-after-dispatch-after-command-after-enable-after-open-after-activation-readiness record",
