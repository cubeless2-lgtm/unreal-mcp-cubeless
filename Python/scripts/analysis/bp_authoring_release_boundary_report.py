...
REPORT_SCHEMA = "section_164_bp_authoring_release_boundary_v106"
...
def build_report(repo_root: Optional[Path] = None, project_root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    preliminary_verdict = {
        "status": "passed",
        "release_boundary_version": "section_164_v106",
        "durable_authoring_enabled": False,
    }
    ...
    return {
        ...
        "next_reinforcement_candidates": [
            "durable executor authoring command execution dry-run contract only after Section 164 dispatch evidence dry-run proof",
