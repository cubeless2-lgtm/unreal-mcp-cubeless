...
import bp_authoring_durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch_contract as durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch
import bp_authoring_durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch_contract as durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch
import bp_authoring_durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch_contract as durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch
...
REPORT_SCHEMA = "section_449_456_bp_authoring_release_boundary_v161"
...
def build_durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    reauthoring_row = build_durable_executor_authoring_post_recreation_actor_bp_reauthoring_actual_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    )
    reauthoring_summary = _summary_from_row_actual(reauthoring_row)
    reauthoring_summary["schema"] = (
        durable_executor_authoring_post_recreation_actor_bp_reauthoring_actual_batch
        .DURABLE_EXECUTOR_AUTHORING_POST_RECREATION_ACTOR_BP_REAUTHORING_ACTUAL_BATCH_SUMMARY_SCHEMA
    )
    readback_result = durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch.build_post_recreation_actor_bp_readback_strengthening_result()
    contract = durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch.build_durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch_contract(
        requested=True,
        section_313_320_post_recreation_actor_bp_reauthoring_actual_summary=(
            reauthoring_summary
        ),
        post_recreation_actor_bp_readback_strengthening_result=(
            readback_result
        ),
    )
    summary = durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch.summarize_durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch_count": 1,
        "section_313_320_summary_schema_matches_count": 1,
        "section_313_320_summary_passed_count": 1,
        "section_313_320_post_recreation_reauthoring_ready_count": 1,
        "section_313_320_destructive_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "readback_strengthening_checkpoint_satisfied_count": 1,
        "recreated_actor_bp_readback_route_ready_count": 1,
        "variable_default_reread_verified_count": 1,
        "default_tag_reread_verified_count": 1,
        "raw_component_duplicate_handles_detected_count": 1,
        "unique_component_identity_verified_count": 1,
        "readback_no_write_dirty_boundary_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
        durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch
    ...
    return row(
        "durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch",
        "Sections 321-328 durable executor post-recreation Actor BP readback strengthening batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 321-328 prove raw duplicate component handles are normalized to one expected SceneComponent identity during readback.",
            "The batch re-reads the variable default, Actor tag, and component identity while all write, compile/save, delete, rename, overwrite, cleanup, graph repair, and production paths remain closed.",
        ),
    )


def build_durable_executor_authoring_post_recreation_function_diagnostics_refresh_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    readback_strengthening_row = build_durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    )
    readback_strengthening_summary = _summary_from_row_actual(
        readback_strengthening_row
    )
    readback_strengthening_summary["schema"] = (
        durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch
        .DURABLE_EXECUTOR_AUTHORING_POST_RECREATION_ACTOR_BP_READBACK_STRENGTHENING_BATCH_SUMMARY_SCHEMA
    )
    diagnostics_result = durable_executor_authoring_post_recreation_function_diagnostics_refresh_batch.build_post_recreation_function_diagnostics_refresh_result()
    contract = durable_executor_authoring_post_recreation_function_diagnostics_refresh_batch.build_durable_executor_authoring_post_recreation_function_diagnostics_refresh_batch_contract(
        requested=True,
        section_321_328_post_recreation_actor_bp_readback_strengthening_summary=(
            readback_strengthening_summary
        ),
        post_recreation_function_diagnostics_refresh_result=(
            diagnostics_result
        ),
    )
    summary = durable_executor_authoring_post_recreation_function_diagnostics_refresh_batch.summarize_durable_executor_authoring_post_recreation_function_diagnostics_refresh_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_post_recreation_function_diagnostics_refresh_batch_count": 1,
        "section_321_328_summary_schema_matches_count": 1,
        "section_321_328_summary_passed_count": 1,
        "section_321_328_post_recreation_readback_strengthened_count": 1,
        "section_321_328_destructive_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "diagnostics_refresh_checkpoint_satisfied_count": 1,
        "current_actor_bp_graph_inventory_ready_count": 1,
        "empty_graph_state_safely_classified_count": 1,
        "function_diagnostics_refreshed_count": 1,
        "pin_contract_diagnostics_refreshed_count": 1,
        "graph_layout_diagnostics_refreshed_count": 1,
        "diagnostics_refresh_no_write_boundary_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
    ...
    return row(
        "durable_executor_authoring_post_recreation_function_diagnostics_refresh_batch",
        "Sections 329-336 durable executor post-recreation function diagnostics refresh batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 329-336 prove the reauthored temp Actor BP's current empty graph/function state is classified through read-only diagnostics refresh.",
            "The batch keeps diagnostics command dispatch, automatic graph repair, node movement, pin rewiring, compile, save, delete, rename, overwrite, cleanup, and production writes closed.",
        ),
    )
...
def build_durable_executor_authoring_graph_repair_execution_dry_run_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    broader_dry_run_row = build_durable_executor_authoring_broader_non_actor_blueprint_dry_run_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    )
    broader_dry_run_summary = _summary_from_row_actual(broader_dry_run_row)
    broader_dry_run_summary["schema"] = (
        durable_executor_authoring_broader_non_actor_blueprint_dry_run_batch
        .DURABLE_EXECUTOR_AUTHORING_BROADER_NON_ACTOR_BLUEPRINT_DRY_RUN_BATCH_SUMMARY_SCHEMA
    )
    dry_run_result = durable_executor_authoring_graph_repair_execution_dry_run_batch.build_graph_repair_execution_dry_run_result()
    contract = durable_executor_authoring_graph_repair_execution_dry_run_batch.build_durable_executor_authoring_graph_repair_execution_dry_run_batch_contract(
        requested=True,
        section_337_344_broader_non_actor_blueprint_dry_run_summary=(
            broader_dry_run_summary
        ),
        graph_repair_execution_dry_run_result=dry_run_result,
    )
    summary = durable_executor_authoring_graph_repair_execution_dry_run_batch.summarize_durable_executor_authoring_graph_repair_execution_dry_run_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_graph_repair_execution_dry_run_batch_count": 1,
        "section_337_344_summary_schema_matches_count": 1,
        "section_337_344_summary_passed_count": 1,
        "section_337_344_broader_non_actor_blueprint_dry_run_ready_count": 1,
        "section_337_344_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "graph_repair_dry_run_checkpoint_satisfied_count": 1,
        "graph_repair_dry_run_command_admitted_count": 1,
        "graph_repair_dry_run_command_executed_count": 1,
        "empty_graph_noop_repair_verified_count": 1,
        "node_pin_mutation_outputs_blocked_count": 1,
        "compile_save_outputs_blocked_count": 1,
        "graph_repair_dry_run_no_write_boundary_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
    ...
    return row(
        ...
        actual=actual,
        notes=(
            "Sections 345-352 admit a dry-run graph repair command/evidence path for the current empty temp Actor Blueprint graph.",
            "The batch proves the dry-run is a no-op while actual graph repair dispatch, node movement, pin rewiring, compile, save, delete, rename, overwrite, cleanup, and production writes remain closed.",
        ),
    )


def build_durable_executor_authoring_post_recreation_non_empty_graph_fixture_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    graph_repair_row = build_durable_executor_authoring_graph_repair_execution_dry_run_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    )
    graph_repair_summary = _summary_from_row_actual(graph_repair_row)
    graph_repair_summary["schema"] = (
        durable_executor_authoring_graph_repair_execution_dry_run_batch
        .DURABLE_EXECUTOR_AUTHORING_GRAPH_REPAIR_EXECUTION_DRY_RUN_BATCH_SUMMARY_SCHEMA
    )
    fixture_result = durable_executor_authoring_post_recreation_non_empty_graph_fixture_batch.build_post_recreation_non_empty_graph_fixture_result()
    contract = durable_executor_authoring_post_recreation_non_empty_graph_fixture_batch.build_durable_executor_authoring_post_recreation_non_empty_graph_fixture_batch_contract(
        requested=True,
        section_345_352_graph_repair_execution_dry_run_summary=graph_repair_summary,
        post_recreation_non_empty_graph_fixture_result=fixture_result,
    )
    summary = durable_executor_authoring_post_recreation_non_empty_graph_fixture_batch.summarize_durable_executor_authoring_post_recreation_non_empty_graph_fixture_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_post_recreation_non_empty_graph_fixture_batch_count": 1,
        "section_345_352_summary_schema_matches_count": 1,
        "section_345_352_summary_passed_count": 1,
        "section_345_352_graph_repair_execution_dry_run_ready_count": 1,
        "section_345_352_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "non_empty_graph_fixture_checkpoint_satisfied_count": 1,
        "fixture_target_scope_verified_count": 1,
        "fixture_actor_blueprint_create_or_update_executed_count": 1,
        "function_graph_inventory_non_empty_verified_count": 1,
        "fixture_compile_save_readback_verified_count": 1,
        "node_level_repair_still_blocked_count": 1,
        "non_fixture_outputs_closed_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
    ...
    return row(
        ...
        actual=actual,
        notes=(
            "Sections 353-360 admit only a scoped /Game/_MCP_Temp/DurableSaveGate Actor Blueprint fixture with a named function graph for non-empty diagnostics inventory.",
            "The batch proves node-level graph repair remains blocked: graph repair dispatch, node movement, pin rewiring, delete, rename, overwrite, cleanup, and production writes stay closed.",
        ),
    )
...
def build_durable_executor_authoring_correct_project_live_mcp_route_preflight_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    node_route_row = build_durable_executor_authoring_node_level_graph_fixture_route_preflight_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    )
    node_route_summary = _summary_from_row_actual(node_route_row)
    node_route_summary["schema"] = (
        durable_executor_authoring_node_level_graph_fixture_route_preflight_batch
        .DURABLE_EXECUTOR_AUTHORING_NODE_LEVEL_GRAPH_FIXTURE_ROUTE_PREFLIGHT_BATCH_SUMMARY_SCHEMA
    )
    live_route_result = durable_executor_authoring_correct_project_live_mcp_route_preflight_batch.build_correct_project_live_mcp_route_preflight_result()
    contract = durable_executor_authoring_correct_project_live_mcp_route_preflight_batch.build_durable_executor_authoring_correct_project_live_mcp_route_preflight_batch_contract(
        requested=True,
        section_361_368_node_level_route_preflight_summary=node_route_summary,
        correct_project_live_mcp_route_preflight_result=live_route_result,
    )
    summary = durable_executor_authoring_correct_project_live_mcp_route_preflight_batch.summarize_durable_executor_authoring_correct_project_live_mcp_route_preflight_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_correct_project_live_mcp_route_preflight_batch_count": 1,
        "section_361_368_summary_schema_matches_count": 1,
        "section_361_368_summary_passed_count": 1,
        "section_361_368_node_level_route_preflight_ready_count": 1,
        "section_361_368_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "correct_project_live_mcp_route_checkpoint_satisfied_count": 1,
        "mcp_config_preflight_verified_count": 1,
        "sibling_server_path_verified_count": 1,
        "live_bridge_read_only_probe_recorded_count": 1,
        "live_bridge_correct_project_not_verified_count": 1,
        "live_mcp_activation_outputs_blocked_count": 1,
        "correct_project_live_mcp_route_no_write_boundary_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
    ...
    return row(
        "durable_executor_authoring_correct_project_live_mcp_route_preflight_batch",
        "Sections 369-376 durable executor correct-project live MCP route preflight batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 369-376 verify the .mcp.json unrealMCP command and sibling server path, then record the live bridge read-only probe.",
            "The batch proves live MCP node authoring remains blocked until the bridge can read the correct-project temp fixture.",
        ),
    )
...
def build_durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    readonly_row = build_durable_executor_authoring_broader_non_actor_live_readonly_preflight_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    )
    readonly_summary = _summary_from_row_actual(readonly_row)
    readonly_summary["schema"] = (
        durable_executor_authoring_broader_non_actor_live_readonly_preflight_batch
        .DURABLE_EXECUTOR_AUTHORING_BROADER_NON_ACTOR_LIVE_READONLY_PREFLIGHT_BATCH_SUMMARY_SCHEMA
    )
    admission_result = durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch.build_broader_non_actor_live_authoring_admission_dry_run_result()
    contract = durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch.build_durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch_contract(
        requested=True,
        section_377_384_broader_non_actor_live_readonly_preflight_summary=readonly_summary,
        broader_non_actor_live_authoring_admission_dry_run_result=admission_result,
    )
    summary = durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch.summarize_durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch_count": 1,
        "section_377_384_summary_schema_matches_count": 1,
        "section_377_384_summary_passed_count": 1,
        "section_377_384_broader_non_actor_live_readonly_preflight_ready_count": 1,
        "section_377_384_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "live_authoring_admission_dry_run_checkpoint_satisfied_count": 1,
        "admission_request_scope_classified_count": 1,
        "user_widget_admission_blocked_pending_widget_tree_contract_count": 1,
        "data_asset_admission_blocked_pending_default_contract_count": 1,
        "anim_blueprint_admission_blocked_pending_skeleton_contract_count": 1,
        "function_library_interface_admission_blocked_pending_graph_contract_count": 1,
        "live_non_actor_creation_outputs_blocked_count": 1,
        "live_non_actor_authoring_admission_no_write_boundary_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
    ...
    return row(
        "durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch",
        "Sections 385-392 durable executor broader non-Actor live authoring admission dry-run batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 385-392 admit only offline admission dry-run classification for broader non-Actor live authoring after the correct-project read-only preflight.",
            "The batch keeps UserWidget, DataAsset-style Blueprint, AnimBlueprint, Blueprint Function Library, and Blueprint Interface creation/mutation blocked until their class-specific contracts exist.",
        ),
    )


def build_durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    admission_row = build_durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    )
    admission_summary = _summary_from_row_actual(admission_row)
    admission_summary["schema"] = (
        durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch
        .DURABLE_EXECUTOR_AUTHORING_BROADER_NON_ACTOR_LIVE_AUTHORING_ADMISSION_DRY_RUN_BATCH_SUMMARY_SCHEMA
    )
    preflight_result = durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch.build_user_widget_widget_tree_live_readonly_preflight_result()
    contract = durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch.build_durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch_contract(
        requested=True,
        section_385_392_non_actor_admission_dry_run_summary=admission_summary,
        user_widget_widget_tree_live_readonly_preflight_result=preflight_result,
    )
    summary = durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch.summarize_durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch_count": 1,
        "section_385_392_summary_schema_matches_count": 1,
        "section_385_392_summary_passed_count": 1,
        "section_385_392_non_actor_admission_dry_run_ready_count": 1,
        "section_385_392_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "user_widget_widget_tree_checkpoint_satisfied_count": 1,
        "correct_project_user_widget_readonly_probe_recorded_count": 1,
        "widget_blueprint_prerequisites_verified_count": 1,
        "root_widget_control_prerequisites_verified_count": 1,
        "widget_tree_creation_mutation_outputs_blocked_count": 1,
        "widget_compile_save_write_outputs_blocked_count": 1,
        "user_widget_widget_tree_no_write_boundary_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
        durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch
    ...
    return row(
        "durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch",
        "Sections 393-400 durable executor UserWidget widget-tree live read-only preflight batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 393-400 record a correct-project headless Unreal read-only probe for WidgetBlueprint, WidgetBlueprintFactory, UserWidget, WidgetTree, CanvasPanel, Button, and TextBlock.",
            "The batch keeps Widget Blueprint creation, root/child widget tree mutation, slot/binding mutation, compile, save, dirty package, cleanup, delete, rename, overwrite, and production writes closed.",
        ),
    )


def build_durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    preflight_row = build_durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    ...
    dry_run_result = durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch.build_user_widget_widget_tree_authoring_dry_run_admission_result()
    contract = durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch.build_durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch_contract(
        requested=True,
        section_393_400_user_widget_widget_tree_preflight_summary=preflight_summary,
        user_widget_widget_tree_authoring_dry_run_admission_result=dry_run_result,
    )
    summary = durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch.summarize_durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch_count": 1,
        "section_393_400_summary_schema_matches_count": 1,
        "section_393_400_summary_passed_count": 1,
        "section_393_400_user_widget_preflight_ready_count": 1,
        "section_393_400_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "user_widget_authoring_dry_run_checkpoint_satisfied_count": 1,
        "widget_blueprint_dry_run_scope_verified_count": 1,
        "root_widget_plan_classified_count": 1,
        "child_widget_slot_plan_classified_count": 1,
        "widget_binding_event_graph_plan_blocked_count": 1,
        "widget_authoring_creation_mutation_outputs_blocked_count": 1,
        "user_widget_authoring_dry_run_no_write_boundary_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
    ...
    return row(
        "durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch",
        "Sections 401-408 durable executor UserWidget widget-tree authoring dry-run admission batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 401-408 admit only an offline dry-run plan for a disposable Widget Blueprint under _MCP_Temp.",
            "The batch records UserWidget parent, CanvasPanel root, Button/TextBlock children, slot layout, and binding/event-graph blockers while keeping creation/mutation/compile/save/write closed.",
        ),
    )


def build_durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    dry_run_row = build_durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    )
    dry_run_summary = _summary_from_row_actual(dry_run_row)
    dry_run_summary["schema"] = (
        durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch
        .DURABLE_EXECUTOR_AUTHORING_USER_WIDGET_WIDGET_TREE_AUTHORING_DRY_RUN_ADMISSION_BATCH_SUMMARY_SCHEMA
    )
    actual_result = durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch.build_user_widget_actual_asset_creation_checkpoint_result()
    contract = durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch.build_durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch_contract(
        requested=True,
        section_401_408_user_widget_dry_run_admission_summary=dry_run_summary,
        user_widget_actual_asset_creation_checkpoint_result=actual_result,
    )
    summary = durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch.summarize_durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch_count": 1,
        "section_401_408_summary_schema_matches_count": 1,
        "section_401_408_summary_passed_count": 1,
        "section_401_408_user_widget_dry_run_ready_count": 1,
        "section_401_408_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "user_widget_actual_creation_checkpoint_satisfied_count": 1,
        "user_widget_actual_target_scope_verified_count": 1,
        "widget_blueprint_create_or_reuse_executed_count": 1,
        "widget_blueprint_compile_save_verified_count": 1,
        "widget_blueprint_readback_package_confirmed_count": 1,
        "widget_tree_mutation_still_blocked_count": 1,
        "user_widget_delete_rename_cleanup_production_blocked_count": 1,
        "user_widget_actual_creation_no_dirty_leftover_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
        durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch
    ...
    return row(
        "durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch",
        "Sections 409-416 durable executor UserWidget actual temp asset creation checkpoint batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 409-416 record the approved correct-project headless Unreal temp Widget Blueprint create-or-reuse, compile, save, and readback checkpoint under _MCP_Temp.",
            "The batch keeps WidgetTree mutation, root/child widget authoring, slot/binding mutation, delete, rename, overwrite, cleanup, and production writes closed.",
        ),
    )


def build_durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    actual_row = build_durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    ...
    route_result = durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch.build_user_widget_widget_tree_mutation_route_preflight_result()
    contract = durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch.build_durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch_contract(
        requested=True,
        section_409_416_user_widget_actual_asset_checkpoint_summary=actual_summary,
        user_widget_widget_tree_mutation_route_preflight_result=route_result,
    )
    summary = durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch.summarize_durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch_count": 1,
        "section_409_416_summary_schema_matches_count": 1,
        "section_409_416_summary_passed_count": 1,
        "section_409_416_user_widget_actual_checkpoint_ready_count": 1,
        "section_409_416_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "user_widget_widget_tree_route_preflight_checkpoint_satisfied_count": 1,
        "user_widget_actual_temp_asset_readonly_confirmed_count": 1,
        "python_widget_tree_mutation_route_blocked_count": 1,
        "unreal_mcp_umg_cpp_route_detected_count": 1,
        "umg_cpp_route_safe_gate_hardening_required_count": 1,
        "widget_tree_mutation_execution_outputs_blocked_count": 1,
        "user_widget_widget_tree_route_preflight_no_write_boundary_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
    ...
    return row(
        "durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch",
        "Sections 417-424 durable executor UserWidget WidgetTree mutation route preflight batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 417-424 record the read-only temp Widget Blueprint route preflight: Python cannot access protected WidgetTree, while existing UnrealMCP UMG C++ route can reach WidgetTree primitives.",
            "The batch keeps actual WidgetTree mutation blocked until the C++ route has _MCP_Temp target-path, no-save, and safety-gate hardening.",
        ),
    )


def build_durable_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
) -> Dict[str, Any]:
    route_row = build_durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch_row(
        contract_summary,
        executor_summary,
        project_root,
        planner_report,
    )
    route_summary = _summary_from_row_actual(route_row)
    route_summary["schema"] = (
        durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch
        .DURABLE_EXECUTOR_AUTHORING_USER_WIDGET_WIDGET_TREE_MUTATION_ROUTE_PREFLIGHT_BATCH_SUMMARY_SCHEMA
    )
    hardening_result = durable_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batch.build_user_widget_widget_tree_umg_cpp_route_hardening_result()
    contract = durable_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batch.build_durable_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batch_contract(
        requested=True,
        section_417_424_user_widget_widget_tree_route_preflight_summary=route_summary,
        user_widget_widget_tree_umg_cpp_route_hardening_result=hardening_result,
    )
    summary = durable_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batch.summarize_durable_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batch_count": 1,
        "section_417_424_summary_schema_matches_count": 1,
        "section_417_424_summary_passed_count": 1,
        "section_417_424_user_widget_route_preflight_ready_count": 1,
        "section_417_424_outputs_closed_count": 1,
        "section_417_424_cpp_route_hardening_required_count": 1,
        "result_schema_matches_count": 1,
        "user_widget_umg_cpp_route_hardening_checkpoint_satisfied_count": 1,
        "user_widget_umg_cpp_temp_scope_gate_verified_count": 1,
        "user_widget_umg_cpp_no_save_default_verified_count": 1,
        "user_widget_umg_cpp_production_path_opt_in_guard_verified_count": 1,
        "user_widget_umg_cpp_widget_tree_mutation_route_hardened_count": 1,
        "user_widget_umg_cpp_build_verified_count": 1,
        "user_widget_umg_cpp_live_command_no_dispatch_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
    ...
    return row(
        "durable_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batch",
        "Sections 425-432 durable executor UserWidget UMG C++ route hardening batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 425-432 record the UnrealMCP UMG C++ route hardening: _MCP_Temp default path, explicit production opt-in, save=false default, guarded SaveAsset, and WidgetTree construction through WidgetTree APIs.",
            "The batch verifies the UBT editor build with -NoHotReloadFromIDE while leaving the editor running, and keeps live WidgetTree mutation command dispatch/write/delete/rename/cleanup closed.",
        ),
    )
...
def build_durable_executor_authoring_data_asset_default_readonly_preflight_batch_row(
    contract_summary: Dict[str, Any],
    executor_summary: Dict[str, Any],
    project_root: Path,
    planner_report: Optional[Dict[str, Any]],
    ...
    data_asset_result = durable_executor_authoring_data_asset_default_readonly_preflight_batch.build_data_asset_default_readonly_preflight_result()
    contract = durable_executor_authoring_data_asset_default_readonly_preflight_batch.build_durable_executor_authoring_data_asset_default_readonly_preflight_batch_contract(
        requested=True,
        section_385_392_non_actor_admission_dry_run_summary=admission_summary,
        data_asset_default_readonly_preflight_result=data_asset_result,
    )
    summary = durable_executor_authoring_data_asset_default_readonly_preflight_batch.summarize_durable_executor_authoring_data_asset_default_readonly_preflight_batches(
        [contract]
    )
    expected = {
        "summary_status": "passed",
        "durable_requested_executor_authoring_data_asset_default_readonly_preflight_batch_count": 1,
        "section_385_392_summary_schema_matches_count": 1,
        "section_385_392_summary_passed_count": 1,
        "section_385_392_non_actor_admission_dry_run_ready_count": 1,
        "section_385_392_outputs_closed_count": 1,
        "result_schema_matches_count": 1,
        "data_asset_default_readonly_checkpoint_satisfied_count": 1,
        "correct_project_data_asset_readonly_probe_recorded_count": 1,
        "data_asset_blueprint_factory_prerequisites_verified_count": 1,
        "primary_data_asset_default_readback_prerequisites_verified_count": 1,
        "data_asset_default_mutation_outputs_blocked_count": 1,
        "data_asset_compile_save_write_outputs_blocked_count": 1,
        "data_asset_default_readonly_no_write_boundary_verified_count": 1,
        "result_has_no_error_count": 1,
        "final_durable_release_ready_count": 1,
    }
    for key in (
        durable_executor_authoring_data_asset_default_readonly_preflight_batch
    ...
    return row(
        "durable_executor_authoring_data_asset_default_readonly_preflight_batch",
        "Sections 449-456 durable executor DataAsset default read-only preflight batch",
        passed=actual == expected,
        expected=expected,
        actual=actual,
        notes=(
            "Sections 449-456 record a correct-project read-only preflight for a PrimaryDataAsset Blueprint default-authoring route.",
            "The batch keeps DataAsset Blueprint creation, default-value mutation, compile, save, dirty package, cleanup, delete, rename, overwrite, and production writes closed.",
        ),
    )
...
def build_report(repo_root: Optional[Path] = None, project_root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    preliminary_verdict = {
        "status": "passed",
        "release_boundary_version": "section_449_456_v161",
        "durable_authoring_enabled": False,
    }
    ...
    matrix = [
        ...
        *safety_rows,
        ...
        build_durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ),
        build_durable_executor_authoring_post_recreation_function_diagnostics_refresh_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ...
        build_durable_executor_authoring_graph_repair_execution_dry_run_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ),
        build_durable_executor_authoring_post_recreation_non_empty_graph_fixture_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ...
        build_durable_executor_authoring_correct_project_live_mcp_route_preflight_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ...
        build_durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ),
        build_durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ),
        build_durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ),
        build_durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ),
        build_durable_executor_authoring_user_widget_widget_tree_mutation_route_preflight_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ),
        build_durable_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
        ...
        build_durable_executor_authoring_data_asset_default_readonly_preflight_batch_row(
            contract_summary,
            executor_summary,
            project_root,
            planner_report,
    ...
    return {
        ...
        "verdict": {
            ...
            "section_321_328_durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_321_durable_authoring_readback_strengthening_checkpoint_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_322_durable_authoring_recreated_actor_bp_readback_route_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_323_durable_authoring_variable_default_reread_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_324_durable_authoring_default_tag_reread_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_325_durable_authoring_raw_component_duplicate_handles_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_326_durable_authoring_unique_component_identity_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_327_durable_authoring_readback_no_write_dirty_boundary_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_328_durable_authoring_readback_strengthening_release_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_329_336_durable_executor_authoring_post_recreation_function_diagnostics_refresh_batch_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_329_durable_authoring_post_recreation_diagnostics_refresh_checkpoint_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_330_durable_authoring_current_actor_bp_graph_inventory_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_331_durable_authoring_empty_graph_state_classification_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_332_durable_authoring_function_diagnostics_refresh_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_333_durable_authoring_pin_contract_diagnostics_refresh_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_334_durable_authoring_graph_layout_diagnostics_refresh_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_335_durable_authoring_diagnostics_refresh_no_write_boundary_status": (
                "passed" if not failed_blocking else "failed"
            ),
            ...
            "section_369_376_durable_executor_authoring_correct_project_live_mcp_route_preflight_batch_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_369_durable_authoring_correct_project_live_mcp_route_checkpoint_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_370_durable_authoring_mcp_config_preflight_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_371_durable_authoring_sibling_server_path_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_372_durable_authoring_live_bridge_read_only_probe_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_373_durable_authoring_live_bridge_correct_project_not_verified_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_374_durable_authoring_live_mcp_activation_outputs_blocked_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_375_durable_authoring_correct_project_live_mcp_route_no_write_boundary_status": (
                "passed" if not failed_blocking else "failed"
            ),
            ...
            "section_393_400_durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_393_durable_authoring_user_widget_widget_tree_checkpoint_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_394_durable_authoring_correct_project_user_widget_readonly_probe_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_395_durable_authoring_widget_blueprint_prerequisites_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_396_durable_authoring_root_widget_control_prerequisites_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_397_durable_authoring_widget_tree_creation_mutation_outputs_blocked_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_398_durable_authoring_widget_compile_save_write_outputs_blocked_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_399_durable_authoring_user_widget_widget_tree_no_write_boundary_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_400_durable_authoring_user_widget_widget_tree_live_readonly_preflight_release_status": (
                "passed" if not failed_blocking else "failed"
            ),
            ...
            "section_409_416_durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_409_durable_authoring_user_widget_actual_creation_checkpoint_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_410_durable_authoring_user_widget_actual_target_scope_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_411_durable_authoring_widget_blueprint_create_or_reuse_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_412_durable_authoring_widget_blueprint_compile_save_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_413_durable_authoring_widget_blueprint_readback_package_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_414_durable_authoring_widget_tree_mutation_still_blocked_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_415_durable_authoring_user_widget_delete_rename_cleanup_production_blocked_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_416_durable_authoring_user_widget_actual_asset_creation_checkpoint_release_status": (
                "passed" if not failed_blocking else "failed"
            ),
            ...
            "section_425_432_durable_executor_authoring_user_widget_umg_cpp_route_hardening_batch_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_425_durable_authoring_user_widget_umg_cpp_route_hardening_checkpoint_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_426_durable_authoring_user_widget_umg_cpp_temp_scope_gate_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_427_durable_authoring_user_widget_umg_cpp_no_save_default_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_428_durable_authoring_user_widget_umg_cpp_production_path_opt_in_guard_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_429_durable_authoring_user_widget_umg_cpp_widget_tree_mutation_route_hardened_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_430_durable_authoring_user_widget_umg_cpp_build_verified_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_431_durable_authoring_user_widget_umg_cpp_live_command_no_dispatch_status": (
                "passed" if not failed_blocking else "failed"
            ),
            ...
            "section_449_456_durable_executor_authoring_data_asset_default_readonly_preflight_batch_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_449_durable_authoring_data_asset_default_readonly_checkpoint_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_450_durable_authoring_correct_project_data_asset_readonly_probe_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_451_durable_authoring_data_asset_blueprint_factory_prerequisites_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_452_durable_authoring_primary_data_asset_default_readback_prerequisites_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_453_durable_authoring_data_asset_default_mutation_outputs_blocked_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_454_durable_authoring_data_asset_compile_save_write_outputs_blocked_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_455_durable_authoring_data_asset_default_readonly_no_write_boundary_status": (
                "passed" if not failed_blocking else "failed"
            ),
            "section_456_durable_authoring_data_asset_default_readonly_preflight_release_status": (
                "passed" if not failed_blocking else "failed"
            ),
            ...
            "post_recreation_actor_bp_readback_strengthened": (
                not failed_blocking
            ),
            ...
            "post_recreation_empty_graph_state_verified": (
                not failed_blocking
            ),
            ...
            "graph_repair_execution_dry_run_ready": not failed_blocking,
            "graph_repair_actual_execution_still_blocked": (
                not failed_blocking
            ),
            "graph_repair_dry_run_noop_verified": not failed_blocking,
            "graph_repair_dry_run_no_write_verified": not failed_blocking,
            "post_recreation_non_empty_graph_fixture_ready": (
                not failed_blocking
            ),
            ...
            "correct_project_live_mcp_route_preflight_ready": (
                not failed_blocking
            ),
            ...
            "broader_non_actor_live_authoring_still_blocked": (
                not failed_blocking
            ),
            ...
            "data_asset_default_readonly_preflight_ready": (
                not failed_blocking
            ),
            "data_asset_default_actual_authoring_still_blocked": (
                not failed_blocking
            ),
            ...
            "widget_blueprint_prerequisites_verified": not failed_blocking,
            ...
            "widget_blueprint_dry_run_scope_verified": not failed_blocking,
            "widget_binding_event_graph_plan_blocked": not failed_blocking,
            "user_widget_actual_asset_creation_checkpoint_ready": (
                not failed_blocking
            ),
            "user_widget_widget_tree_mutation_still_blocked": (
                not failed_blocking
            ),
            "user_widget_temp_package_file_confirmed": not failed_blocking,
            "user_widget_widget_tree_mutation_route_preflight_ready": (
                not failed_blocking
            ),
            "python_widget_tree_mutation_route_blocked": not failed_blocking,
            "unreal_mcp_umg_cpp_route_detected": not failed_blocking,
            "umg_cpp_route_safe_gate_hardening_required": not failed_blocking,
            ...
            "current_authoring_ceiling": (
                ...
                "_and_section_385_392_durable_executor_authoring_broader_non_actor_live_authoring_admission_dry_run_ready"
                "_and_section_393_400_durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_ready"
                "_and_section_401_408_durable_executor_authoring_user_widget_widget_tree_authoring_dry_run_admission_ready"
        ...
        "next_reinforcement_candidates": [
            ...
            "DataAsset default dry-run admission and Blueprint Function Library live authoring class-specific admission gates",
        ],
    }
...
def render_markdown(report: Dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "## Decision",
            "",
            "This boundary records the staged durable authoring gates through Section 456. The UserWidget UMG C++ route is hardened and build-verified, but 127.0.0.1:55557 is owned by a different workspace editor, so correct-workspace bridge start and live WidgetTree mutation dispatch remain blocked until the port is released and owned by the managed CubelessStylized editor. The DataAsset default-authoring route is only read-only preflighted; creation, default mutation, compile, save, cleanup, delete, rename, overwrite, and production writes remain closed.",
            "",
