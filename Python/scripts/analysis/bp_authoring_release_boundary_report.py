...
REPORT_SCHEMA = "section_143_bp_authoring_release_boundary_v85"
...
def build_report(repo_root: Optional[Path] = None, project_root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    preliminary_verdict = {
        "status": "passed",
        "release_boundary_version": "section_143_v85",
        "durable_authoring_enabled": False,
    }
    ...
    return {
        ...
        "next_reinforcement_candidates": [
            "durable executor authoring enable-after-open contract only after durable executor authoring open-after-activation-readiness record",
