...
REPORT_SCHEMA = "section_144_bp_authoring_release_boundary_v86"
...
def build_report(repo_root: Optional[Path] = None, project_root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    preliminary_verdict = {
        "status": "passed",
        "release_boundary_version": "section_144_v86",
        "durable_authoring_enabled": False,
    }
    ...
    return {
        ...
        "next_reinforcement_candidates": [
            "durable executor authoring command contract only after durable executor authoring enable-after-open-after-activation-readiness record",
