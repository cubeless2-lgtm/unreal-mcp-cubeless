...
after the durable authoring release promotion barrier-after-decision record is valid. It does
...
DURABLE_EXECUTOR_AUTHORING_ACTIVATION_READINESS_AFTER_PROMOTION_BARRIER_SCHEMA = (
    "section_142_durable_executor_authoring_activation_readiness_after_promotion_barrier_contract_v1"
)
DURABLE_EXECUTOR_AUTHORING_ACTIVATION_READINESS_AFTER_PROMOTION_BARRIER_RECORD_SCHEMA = (
    "section_142_durable_executor_authoring_activation_readiness_after_promotion_barrier_record_v1"
)
DURABLE_EXECUTOR_AUTHORING_ACTIVATION_READINESS_AFTER_PROMOTION_BARRIER_SUMMARY_SCHEMA = (
    "section_142_durable_executor_authoring_activation_readiness_after_promotion_barrier_summary_v1"
)
EXPECTED_ACTIVATION_READINESS_SCOPE = (
    "durable_executor_authoring_activation_readiness_after_promotion_barrier_only"
)
...
def build_durable_executor_authoring_activation_readiness_after_promotion_barrier_contract(
    requested: bool,
    ...
    if requested:
        if not release_promotion_barrier_inputs_satisfied:
            missing.append("section_141_release_promotion_barrier_inputs_satisfied")
        if not release_promotion_barrier_record_valid:
            missing.append("section_141_release_promotion_barrier_record_valid")
        if not allowed_release_promotion_barrier_observed:
            missing.append("section_141_allowed_release_promotion_barrier_observed")
        if not no_forbidden_release_promotion_barrier_claims:
            missing.append(
                "section_141_no_forbidden_release_promotion_barrier_claims"
            )
        ...
        if not activation_readiness_scope_matches:
            missing.append("durable_executor_authoring_activation_readiness_after_promotion_barrier_only_scope")
        ...
        missing.append("separate_durable_executor_authoring_open_after_activation_readiness_contract")
    activation_readiness_record_rejected = bool(
        readiness_record_present and not activation_readiness_record_valid
    )
    contract: Dict[str, Any] = {
        "id": "durable_executor_authoring_activation_readiness_after_promotion_barrier",
        "schema": DURABLE_EXECUTOR_AUTHORING_ACTIVATION_READINESS_AFTER_PROMOTION_BARRIER_SCHEMA,
        "requested": requested,
...
def summarize_durable_executor_authoring_activation_readiness_after_promotion_barrier(
    ...
    summary: Dict[str, Any] = {
        "schema": DURABLE_EXECUTOR_AUTHORING_ACTIVATION_READINESS_AFTER_PROMOTION_BARRIER_SUMMARY_SCHEMA,
        "status": status,
        "durable_requested_executor_authoring_activation_readiness_after_promotion_barrier_count": len(
            requested
        ),
