#!/usr/bin/env python
"""Offline smoke tests for bp_authoring_durable_executor_authoring_promotion_barrier_after_activation_readiness_contract.py."""
...
import bp_authoring_durable_executor_authoring_promotion_barrier_after_activation_readiness_contract as barrier  # noqa: E402


def build_current_release_decision_after_review_summary() -> dict:
    return {
        "schema": decision.DURABLE_EXECUTOR_AUTHORING_RELEASE_DECISION_AFTER_REVIEW_AFTER_READINESS_AFTER_NO_SAVE_RELEASE_AFTER_READBACK_AFTER_RESULT_AFTER_APPLICATION_AFTER_DECISION_AFTER_EVIDENCE_AFTER_EXECUTION_AFTER_DISPATCH_AFTER_COMMAND_AFTER_ENABLE_AFTER_OPEN_AFTER_ACTIVATION_READINESS_SUMMARY_SCHEMA,
        "status": "passed",
...
def build_release_promotion_barrier_record(**overrides: object) -> dict:
    record = {
        "schema": barrier.DURABLE_EXECUTOR_AUTHORING_RELEASE_PROMOTION_BARRIER_AFTER_DECISION_AFTER_REVIEW_AFTER_READINESS_AFTER_NO_SAVE_RELEASE_AFTER_READBACK_AFTER_RESULT_AFTER_APPLICATION_AFTER_DECISION_AFTER_EVIDENCE_AFTER_EXECUTION_AFTER_DISPATCH_AFTER_COMMAND_AFTER_ENABLE_AFTER_OPEN_AFTER_ACTIVATION_READINESS_RECORD_SCHEMA,
...
def main() -> int:
    ...
    contract = barrier.build_durable_executor_authoring_release_promotion_barrier_after_decision_after_review_after_readiness_after_no_save_release_after_readback_after_result_after_application_after_decision_after_evidence_after_execution_after_dispatch_after_command_after_enable_after_open_after_activation_readiness_contract(
        True,
        current_summary,
    )
    assert (
    ...
    assert "section_156_release_decision_inputs_satisfied" in contract[
        "missing_release_promotion_barrier_prerequisites"
    ]
    assert "section_156_release_decision_record_valid" in contract[
        "missing_release_promotion_barrier_prerequisites"
    ]
    assert "section_156_allowed_release_decision_observed" in contract[
        "missing_release_promotion_barrier_prerequisites"
    ]
    assert "section_156_no_forbidden_release_decision_claims" in contract[
        "missing_release_promotion_barrier_prerequisites"
    ]
    ...
    summary = barrier.summarize_durable_executor_authoring_release_promotion_barriers_after_decision_after_review_after_readiness_after_no_save_release_after_readback_after_result_after_application_after_decision_after_evidence_after_execution_after_dispatch_after_command_after_enable_after_open_after_activation_readiness(
        [contract]
    )
    ...
    future_contract = barrier.build_durable_executor_authoring_release_promotion_barrier_after_decision_after_review_after_readiness_after_no_save_release_after_readback_after_result_after_application_after_decision_after_evidence_after_execution_after_dispatch_after_command_after_enable_after_open_after_activation_readiness_contract(
        True,
        future_summary,
    ...
    unsafe_contract = barrier.build_durable_executor_authoring_release_promotion_barrier_after_decision_after_review_after_readiness_after_no_save_release_after_readback_after_result_after_application_after_decision_after_evidence_after_execution_after_dispatch_after_command_after_enable_after_open_after_activation_readiness_contract(
        True,
        future_summary,
    ...
    activation_contract = barrier.build_durable_executor_authoring_release_promotion_barrier_after_decision_after_review_after_readiness_after_no_save_release_after_readback_after_result_after_application_after_decision_after_evidence_after_execution_after_dispatch_after_command_after_enable_after_open_after_activation_readiness_contract(
        True,
        future_summary,
        build_release_promotion_barrier_record(
