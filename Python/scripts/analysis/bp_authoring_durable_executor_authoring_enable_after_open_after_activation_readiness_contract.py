...
authoring-enable-after-open-after-activation-readiness-only record after the
durable executor authoring open-after-activation-readiness record is valid. It
...
DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_AFTER_ACTIVATION_READINESS_SCHEMA = (
    "section_144_durable_executor_authoring_enable_after_open_after_activation_readiness_contract_v1"
)
DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_AFTER_ACTIVATION_READINESS_RECORD_SCHEMA = (
    "section_144_durable_executor_authoring_enable_after_open_after_activation_readiness_record_v1"
)
DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_AFTER_ACTIVATION_READINESS_SUMMARY_SCHEMA = (
    "section_144_durable_executor_authoring_enable_after_open_after_activation_readiness_summary_v1"
)
EXPECTED_AUTHORING_ENABLE_SCOPE = "durable_executor_authoring_enable_after_open_after_activation_readiness_only"
...
def build_durable_executor_authoring_enable_after_open_after_activation_readiness_contract(
    requested: bool,
    ...
    if requested:
        if not open_inputs_satisfied:
            missing.append("section_143_open_inputs_satisfied")
        if not open_record_valid:
            missing.append("section_143_open_record_valid")
        if not allowed_open_observed:
            missing.append("section_143_allowed_open_observed")
        if not no_forbidden_open_claims:
            missing.append("section_143_no_forbidden_open_claims")
        ...
        if not enable_scope_matches:
            missing.append("durable_executor_authoring_enable_after_open_after_activation_readiness_only_scope")
        ...
        missing.append("separate_durable_authoring_command_after_enable_contract")
    authoring_enable_record_rejected = bool(
        enable_record_present and not authoring_enable_record_valid
    )
    contract: Dict[str, Any] = {
        "id": "durable_executor_authoring_enable_after_open_after_activation_readiness",
        "schema": DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_AFTER_ACTIVATION_READINESS_SCHEMA,
        "requested": requested,
...
def summarize_durable_executor_authoring_enable_after_open_after_activation_readiness(
    ...
    summary: Dict[str, Any] = {
        "schema": DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_AFTER_ACTIVATION_READINESS_SUMMARY_SCHEMA,
        "status": status,
        "durable_requested_executor_authoring_enable_after_open_after_activation_readiness_count": len(requested),
