...
This contract validates a future authoring-open-after-activation-readiness-only
...
DURABLE_EXECUTOR_AUTHORING_OPEN_AFTER_ACTIVATION_READINESS_SCHEMA = (
    "section_143_durable_executor_authoring_open_after_activation_readiness_contract_v1"
)
DURABLE_EXECUTOR_AUTHORING_OPEN_AFTER_ACTIVATION_READINESS_RECORD_SCHEMA = (
    "section_143_durable_executor_authoring_open_after_activation_readiness_record_v1"
)
DURABLE_EXECUTOR_AUTHORING_OPEN_AFTER_ACTIVATION_READINESS_SUMMARY_SCHEMA = (
    "section_143_durable_executor_authoring_open_after_activation_readiness_summary_v1"
)
EXPECTED_OPEN_SCOPE = "durable_executor_authoring_open_after_activation_readiness_only"
...
def build_durable_executor_authoring_open_after_activation_readiness_contract(
    requested: bool,
    ...
    record_schema_matches = bool(
        open_record_present
        and open_record.get("schema") == DURABLE_EXECUTOR_AUTHORING_OPEN_AFTER_ACTIVATION_READINESS_RECORD_SCHEMA
    )
    ...
    if requested:
        if not activation_readiness_inputs_satisfied:
            missing.append("section_142_activation_readiness_inputs_satisfied")
        if not activation_readiness_record_valid:
            missing.append("section_142_activation_readiness_record_valid")
        if not allowed_activation_readiness_observed:
            missing.append("section_142_allowed_activation_readiness_observed")
        if not no_forbidden_activation_readiness_claims:
            missing.append("section_142_no_forbidden_activation_readiness_claims")
        ...
        if not open_scope_matches:
            missing.append("durable_executor_authoring_open_after_activation_readiness_only_scope")
        ...
        missing.append("separate_durable_authoring_enable_after_open_contract")
    open_record_rejected = bool(open_record_present and not open_record_valid)
    contract: Dict[str, Any] = {
        "id": "durable_executor_authoring_open_after_activation_readiness",
        "schema": DURABLE_EXECUTOR_AUTHORING_OPEN_AFTER_ACTIVATION_READINESS_SCHEMA,
        "requested": requested,
        "open_contract_defined": open_contract_defined,
        "required_open_record_schema": (
            DURABLE_EXECUTOR_AUTHORING_OPEN_AFTER_ACTIVATION_READINESS_RECORD_SCHEMA if requested else ""
        ),
...
def summarize_durable_executor_authoring_opens_after_activation_readiness(
    ...
    summary: Dict[str, Any] = {
        "schema": DURABLE_EXECUTOR_AUTHORING_OPEN_AFTER_ACTIVATION_READINESS_SUMMARY_SCHEMA,
        "status": status,
        "durable_requested_executor_authoring_open_after_activation_readiness_count": len(requested),
