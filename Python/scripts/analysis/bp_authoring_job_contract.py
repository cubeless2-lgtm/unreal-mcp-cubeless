...
MANIFEST_VERSION = "section_58_bp_authoring_job_contract_v36"
...
def build_durable_preflight_contract(
    ...
    canary_prep_contract = durable_canary.build_canary_prep_contract(
        requested=requested,
        source_target_asset_path=target_asset_path,
    ...
    canary_live_preflight_contract = durable_canary_live_preflight.build_canary_live_preflight_contract(
        requested=requested,
        canary_prep_contract=canary_prep_contract,
...
def summarize_manifests(manifests: Sequence[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    return {
        ...
        "durable_canary_prep_summary": canary_prep_summary,
        "durable_canary_prep_request_count": canary_prep_summary["durable_requested_canary_prep_count"],
        "durable_canary_prep_ready_count": canary_prep_summary["canary_prep_ready_count"],
        "durable_canary_live_execution_allowed_count": canary_prep_summary["canary_live_execution_allowed_count"],
        "durable_canary_general_blueprints_package_allowed_count": canary_prep_summary[
        ...
        "durable_canary_live_preflight_summary": canary_live_preflight_summary,
        "durable_canary_live_preflight_request_count": canary_live_preflight_summary[
            "durable_requested_canary_live_preflight_count"
        ],
        "durable_canary_live_preflight_read_only_allowed_count": canary_live_preflight_summary[
            "read_only_live_preflight_allowed_count"
        ],
        "durable_canary_live_preflight_execution_allowed_count": canary_live_preflight_summary[
            "canary_execution_allowed_after_preflight_count"
        ],
        "durable_canary_live_preflight_authoring_command_allowed_count": canary_live_preflight_summary[
            "authoring_command_allowed_count"
        ],
        "durable_canary_live_preflight_save_or_delete_allowed_count": canary_live_preflight_summary[
            "save_or_delete_allowed_count"
        ],
        "durable_canary_live_preflight_cleanup_command_allowed_count": canary_live_preflight_summary[
            "cleanup_command_allowed_count"
        ],
        "durable_canary_live_preflight_authoring_command_count": canary_live_preflight_summary[
            "live_authoring_command_count"
        ],
        "durable_canary_live_preflight_save_or_delete_command_count": canary_live_preflight_summary[
        ...
        "durable_canary_recovery_matrix_ready_count": canary_recovery_summary["recovery_matrix_ready_count"],
        "durable_canary_recovery_scenario_count": canary_recovery_summary["scenario_count"],
        "durable_canary_recovery_cleanup_command_allowed_count": canary_recovery_summary[
            "cleanup_command_allowed_count"
        ],
        "durable_canary_recovery_delete_command_allowed_count": canary_recovery_summary[
            "delete_command_allowed_count"
        ],
        "durable_canary_recovery_save_command_allowed_count": canary_recovery_summary["save_command_allowed_count"],
        "durable_canary_recovery_authoring_command_allowed_count": canary_recovery_summary[
            "authoring_command_allowed_count"
        ],
        "durable_canary_recovery_live_cleanup_command_count": canary_recovery_summary["live_cleanup_command_count"],
        "durable_canary_recovery_live_delete_command_count": canary_recovery_summary["live_delete_command_count"],
        "durable_canary_recovery_live_save_command_count": canary_recovery_summary["live_save_command_count"],
        "durable_canary_recovery_live_authoring_command_count": canary_recovery_summary[
            "live_authoring_command_count"
        ],
...
def render_markdown(report: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Durable canary prep requests: `{summary['durable_canary_prep_request_count']}`",
