#!/usr/bin/env python
"""Offline smoke tests for Section 180 command admission dry-run contract."""
...
def main() -> int:
    run_stage_smoke(
        ...
        command_admission.summarize_durable_executor_authoring_command_admission_dry_runs,
        "durable_authoring_command_allowed",
    )
    print(
        "BP authoring durable executor authoring command admission dry-run contract smoke passed"
    )
    return 0
