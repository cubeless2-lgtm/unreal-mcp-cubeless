...
This contract validates a future authoring-enable-only record after the durable
executor authoring open record is valid. It does not enable durable authoring,
start authoring commands, open the executor, write assets, dirty packages, save,
...
DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_SCHEMA = (
    "section_128_durable_executor_authoring_enable_after_open_contract_v1"
)
DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_RECORD_SCHEMA = (
    "section_128_durable_executor_authoring_enable_after_open_record_v1"
)
DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_SUMMARY_SCHEMA = (
    "section_128_durable_executor_authoring_enable_after_open_summary_v1"
)
EXPECTED_AUTHORING_ENABLE_SCOPE = "durable_executor_authoring_enable_after_open_only"
...
def build_durable_executor_authoring_enable_after_open_contract(
    requested: bool,
    ...
    if requested:
        if not open_inputs_satisfied:
            missing.append("section_127_open_inputs_satisfied")
        if not open_record_valid:
            missing.append("section_127_open_record_valid")
        if not allowed_open_observed:
            missing.append("section_127_allowed_open_observed")
        if not no_forbidden_open_claims:
            missing.append("section_127_no_forbidden_open_claims")
        ...
        if not enable_scope_matches:
            missing.append("durable_executor_authoring_enable_after_open_only_scope")
    ...
    contract: Dict[str, Any] = {
        "id": "durable_executor_authoring_enable_after_open",
        "schema": DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_SCHEMA,
        "requested": requested,
...
def summarize_durable_executor_authoring_enable_after_open(
    ...
    summary: Dict[str, Any] = {
        "schema": DURABLE_EXECUTOR_AUTHORING_ENABLE_AFTER_OPEN_SUMMARY_SCHEMA,
        "status": status,
        "durable_requested_executor_authoring_enable_after_open_count": len(requested),
