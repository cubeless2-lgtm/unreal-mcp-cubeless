...
""",
        ...
        assert report["verdict"]["section_186_durable_executor_open_status"] == "passed"
        assert (
            report["verdict"]["section_187_durable_executor_open_readiness_status"]
            == "passed"
        )
        assert (
            report["verdict"]["section_188_durable_authoring_command_allow_status"]
            == "passed"
        )
        assert (
            report["verdict"]["section_189_durable_authoring_command_dispatch_status"]
            == "passed"
        )
        assert (
            report["verdict"][
        ...
        assert (
            report["verdict"]["section_202_durable_authoring_save_gate_open_status"]
            == "passed"
        )
        assert (
            report["verdict"][
        ...
        assert (
            report["verdict"][
                "section_481_488_durable_executor_authoring_non_actor_actual_temp_checkpoint_bridge_blocker_batch_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_481_durable_authoring_non_actor_actual_temp_checkpoint_bridge_blocker_checkpoint_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_482_durable_authoring_data_asset_actual_temp_checkpoint_preconditions_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_483_durable_authoring_bfl_actual_temp_checkpoint_preconditions_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_484_durable_authoring_wrong_workspace_bridge_blocker_reconfirmed_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_485_durable_authoring_live_non_actor_temp_creation_dispatch_blocked_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_486_durable_authoring_non_actor_temp_compile_save_write_outputs_blocked_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_487_durable_authoring_non_actor_actual_temp_checkpoint_no_write_boundary_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_488_durable_authoring_non_actor_actual_temp_checkpoint_bridge_blocker_release_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_489_496_durable_executor_authoring_correct_workspace_bridge_takeover_handoff_batch_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_489_durable_authoring_correct_workspace_bridge_takeover_handoff_checkpoint_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_490_durable_authoring_wrong_workspace_bridge_owner_context_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_491_durable_authoring_correct_workspace_bridge_launch_plan_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_492_durable_authoring_automatic_bridge_takeover_blocked_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_493_durable_authoring_post_takeover_bridge_verification_chain_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_494_durable_authoring_live_durable_dispatch_after_takeover_blocked_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_495_durable_authoring_correct_workspace_bridge_takeover_handoff_no_write_boundary_status"
            ]
            == "passed"
        )
        assert (
        ...
        assert (
            report["verdict"][
                "section_513_520_durable_executor_authoring_correct_workspace_bridge_verification_evidence_schema_batch_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_513_durable_authoring_verification_evidence_schema_checkpoint_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_514_durable_authoring_required_evidence_fields_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_515_durable_authoring_project_identity_evidence_requirements_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_516_durable_authoring_bridge_identity_evidence_requirements_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_517_durable_authoring_read_only_probe_evidence_requirements_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_518_durable_authoring_evidence_ingest_and_admission_blocked_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_519_durable_authoring_verification_evidence_schema_no_write_boundary_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_520_durable_authoring_verification_evidence_schema_release_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_521_528_durable_executor_authoring_correct_workspace_bridge_verification_evidence_payload_dry_run_batch_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_521_durable_authoring_verification_evidence_payload_dry_run_checkpoint_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_522_durable_authoring_payload_template_fields_mapped_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_523_durable_authoring_payload_identity_expectations_bound_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_524_durable_authoring_payload_dirty_state_placeholders_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_525_durable_authoring_rejection_fixture_matrix_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_526_durable_authoring_payload_ingest_and_admission_still_blocked_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_527_durable_authoring_payload_dry_run_no_write_boundary_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_528_durable_authoring_payload_dry_run_release_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_529_536_durable_executor_authoring_correct_workspace_bridge_verification_evidence_validation_rule_dry_run_batch_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_529_durable_authoring_verification_evidence_validation_rule_dry_run_checkpoint_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_530_durable_authoring_schema_validation_rules_recorded_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_531_durable_authoring_identity_validation_rules_recorded_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_532_durable_authoring_read_only_probe_validation_rules_recorded_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_533_durable_authoring_dirty_state_validation_rules_recorded_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_534_durable_authoring_timestamp_and_placeholder_rejection_rules_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_535_durable_authoring_validation_execution_and_admission_still_blocked_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_536_durable_authoring_validation_rule_dry_run_release_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_537_544_durable_executor_authoring_correct_workspace_bridge_verification_evidence_validation_execution_dry_run_envelope_batch_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_537_durable_authoring_validation_execution_dry_run_envelope_checkpoint_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_538_durable_authoring_validation_execution_scope_recorded_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_539_durable_authoring_real_evidence_payload_required_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_540_durable_authoring_validation_rule_set_binding_required_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_541_durable_authoring_validation_execution_authorization_still_required_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_542_durable_authoring_validation_result_admission_still_blocked_status"
            ]
            == "passed"
        )
        assert (
            report["verdict"][
                "section_543_durable_authoring_validation_execution_dry_run_no_write_boundary_status"
            ]
            == "passed"
        )
        assert (
        ...
        assert report["verdict"]["durable_executor_opened"] is True
        assert (
            report["verdict"]["durable_authoring_command_no_save_execution_ready"]
            is True
        )
        ...
        assert report["verdict"]["save_gate_open_allowed"] is True
        assert report["verdict"]["save_gate_opened"] is True
        ...
        assert (
            report["verdict"]["live_actor_bp_authoring_preflight_allowed"]
            is True
        )
        assert report["verdict"]["live_actor_bp_authoring_checkpoint_ready"] is True
        assert (
            report["verdict"][
        ...
        assert (
            report["verdict"]["live_actor_bp_actual_authoring_executed"]
            is True
        )
        assert report["verdict"]["live_actor_bp_actual_authoring_saved"] is True
        assert (
            report["verdict"][
        ...
        assert (
            report["verdict"]["actor_bp_authoring_external_dirty_preserved"]
            is True
        )
        assert (
            report["verdict"][
        ...
        assert report["verdict"]["cleanup_delete_actual_execution_ready"] is True
        assert report["verdict"]["cleanup_delete_actual_target_deleted"] is True
        assert (
            report["verdict"][
        ...
        assert report["verdict"]["post_delete_recreate_asset_allowed"] is True
        assert (
        ...
        assert report["verdict"]["post_delete_recreated_actor_bp_saved"] is True
        assert (
            report["verdict"][
        ...
        assert (
            report["verdict"]["post_recreation_actor_bp_readback_strengthened"]
            is True
        )
        assert (
            report["verdict"][
        ...
        assert (
            report["verdict"]["post_recreation_function_diagnostics_refreshed"]
            is True
        )
        assert (
            report["verdict"]["post_recreation_empty_graph_state_verified"]
            is True
        )
        assert (
            report["verdict"][
        ...
        assert (
            report["verdict"]["broader_non_actor_blueprint_dry_run_ready"]
            is True
        )
        assert (
            report["verdict"]["broader_blueprint_actual_authoring_still_blocked"]
            is True
        )
        assert report["verdict"]["user_widget_authoring_plan_classified"] is True
        assert report["verdict"]["data_asset_authoring_plan_classified"] is True
        assert report["verdict"]["anim_blueprint_authoring_plan_classified"] is True
        assert (
        ...
        assert (
            report["verdict"]["correct_project_live_mcp_route_preflight_ready"]
            is True
        )
        assert (
            report["verdict"]["correct_project_live_mcp_activation_still_blocked"]
            is True
        )
        ...
        assert report["verdict"]["widget_blueprint_prerequisites_verified"] is True
        assert (
        ...
        assert (
            report["verdict"]["user_widget_actual_asset_creation_checkpoint_ready"]
            is True
        )
        assert (
            report["verdict"]["user_widget_widget_tree_mutation_still_blocked"]
            is True
        )
        ...
        assert report["verdict"]["cleanup_allowed"] is False
        assert report["verdict"]["cleanup_executed"] is False
        assert report["verdict"]["save_delete_rename_allowed"] is False
        assert report["verdict"]["delete_asset_allowed"] is True
        assert report["verdict"]["delete_asset_executed"] is True
        ...
        assert report["verdict"]["variable_add_command_dispatched"] is True
        assert report["verdict"]["variable_add_command_executed"] is True
        assert report["verdict"]["component_add_command_dispatched"] is True
        assert report["verdict"]["component_add_command_executed"] is True
        assert report["verdict"]["default_write_command_dispatched"] is True
        assert report["verdict"]["default_write_command_executed"] is True
        assert report["verdict"]["actor_bp_authoring_command_dispatched"] is True
        assert report["verdict"]["actor_bp_authoring_command_executed"] is True
        assert report["verdict"]["actor_bp_authoring_compile_dispatched"] is True
        assert report["verdict"]["actor_bp_authoring_compile_executed"] is True
        assert report["verdict"]["actor_bp_authoring_save_dispatched"] is True
        assert report["verdict"]["actor_bp_authoring_save_executed"] is True
        assert (
        ...
        assert report["verdict"]["actor_bp_authoring_target_dirty_after"] is False
        ...
        command_admission_dry_run_row = find_row(
            report,
            "durable_executor_authoring_command_admission_dry_run_contract",
        )
        assert command_admission_dry_run_row["status"] == "passed"
        assert (
            command_admission_dry_run_row["actual"][
                "durable_requested_executor_authoring_command_admission_dry_run_count"
            ]
            == 1
        )
        assert (
        ...
        assert command_admission_dry_run_row["actual"]["command_path_chain_satisfied_count"] == 0
        assert (
            command_admission_dry_run_row["actual"][
        ...
        assert command_admission_dry_run_row["actual"]["durable_authoring_command_contract_started_count"] == 0
        assert command_admission_dry_run_row["actual"]["durable_authoring_command_allowed_count"] == 0
        ...
        unlock_decision_row = find_row(
            report,
            "durable_executor_authoring_safety_boundary_unlock_decision",
        )
        assert unlock_decision_row["status"] == "passed"
        assert (
            unlock_decision_row["actual"][
                "durable_requested_executor_authoring_safety_boundary_unlock_decision_count"
            ]
            == 1
        )
        assert unlock_decision_row["actual"]["unlock_decision_checkpoint_only_count"] == 1
        assert unlock_decision_row["actual"]["unlock_decision_checkpoint_reached_count"] == 1
        assert (
            unlock_decision_row["actual"][
                "section_181_release_boundary_consolidated_count"
            ]
            == 1
        )
        assert unlock_decision_row["actual"]["section_181_unlock_ready_absent_count"] == 1
        assert unlock_decision_row["actual"]["section_181_authoring_disabled_count"] == 1
        assert unlock_decision_row["actual"]["section_181_final_release_not_ready_count"] == 1
        assert unlock_decision_row["actual"]["blocked_outputs_zero_count"] == 1
        assert unlock_decision_row["actual"]["unlock_decision_record_present_count"] == 0
        assert unlock_decision_row["actual"]["unlock_decision_record_absent_count"] == 1
        assert unlock_decision_row["actual"]["explicit_unlock_approval_present_count"] == 0
        assert unlock_decision_row["actual"]["explicit_unlock_approval_absent_count"] == 1
        assert unlock_decision_row["actual"]["unlock_requires_explicit_user_approval_count"] == 1
        assert unlock_decision_row["actual"]["unlock_record_admissible_count"] == 0
        assert unlock_decision_row["actual"]["durable_safety_boundary_unlock_ready_count"] == 0
        assert unlock_decision_row["actual"]["durable_safety_boundary_unlocked_count"] == 0
        assert unlock_decision_row["actual"]["durable_authoring_enabled_count"] == 0
        assert unlock_decision_row["actual"]["final_durable_release_ready_count"] == 0
        ...
        assert unlock_row["status"] == "passed"
        assert (
            unlock_row["actual"][
        ...
        assert unlock_row["actual"]["section_183_summary_schema_matches_count"] == 1
        assert unlock_row["actual"]["section_183_summary_passed_count"] == 1
        assert unlock_row["actual"]["section_183_unlock_record_admissible_count"] == 1
        assert unlock_row["actual"]["section_183_unlock_ready_count"] == 1
        assert unlock_row["actual"]["section_183_unlocked_absent_count"] == 1
        assert unlock_row["actual"]["section_183_authoring_disabled_count"] == 1
        assert unlock_row["actual"]["section_183_final_release_not_ready_count"] == 1
        assert unlock_row["actual"]["section_183_save_delete_rename_blocked_count"] == 1
        assert (
            unlock_row["actual"]["section_183_live_durable_authoring_blocked_count"]
            == 1
        )
        assert unlock_row["actual"]["blocked_outputs_zero_count"] == 1
        assert unlock_row["actual"]["durable_safety_boundary_unlocked_count"] == 1
        assert unlock_row["actual"]["durable_authoring_enabled_count"] == 0
        assert unlock_row["actual"]["final_durable_release_ready_count"] == 0
        assert unlock_row["actual"]["durable_executor_open_allowed_count"] == 0
        assert unlock_row["actual"]["durable_authoring_command_allowed_count"] == 0
        ...
        no_save_batch_row = find_row(
            report,
            "durable_executor_authoring_no_save_execution_batch",
        )
        assert no_save_batch_row["status"] == "passed"
        assert (
            no_save_batch_row["actual"][
                "durable_requested_executor_authoring_no_save_execution_batch_count"
            ]
            == 1
        )
        assert (
            no_save_batch_row["actual"]["section_185_summary_schema_matches_count"]
            == 1
        )
        assert no_save_batch_row["actual"]["section_185_summary_passed_count"] == 1
        assert no_save_batch_row["actual"]["section_185_authoring_enabled_count"] == 1
        assert no_save_batch_row["actual"]["section_185_final_release_not_ready_count"] == 1
        assert no_save_batch_row["actual"]["section_185_executor_open_blocked_count"] == 1
        assert no_save_batch_row["actual"]["section_185_command_allow_blocked_count"] == 1
        assert (
            no_save_batch_row["actual"]["section_185_save_delete_rename_blocked_count"]
            == 1
        )
        assert (
            no_save_batch_row["actual"][
                "section_185_live_durable_authoring_blocked_count"
            ]
            == 1
        )
        assert no_save_batch_row["actual"]["blocked_outputs_zero_count"] == 1
        assert no_save_batch_row["actual"]["no_save_execution_batch_admissible_count"] == 1
        assert no_save_batch_row["actual"]["section_186_executor_opened_count"] == 1
        assert (
            no_save_batch_row["actual"]["section_187_open_readiness_consolidated_count"]
            == 1
        )
        assert (
            no_save_batch_row["actual"]["section_188_authoring_command_allowed_count"]
            == 1
        )
        assert (
            no_save_batch_row["actual"]["section_189_command_dispatch_gate_open_count"]
            == 1
        )
        assert (
            no_save_batch_row["actual"][
        ...
        assert (
            no_save_batch_row["actual"]["section_191_completion_readback_ready_count"]
            == 1
        )
        assert (
            no_save_batch_row["actual"]["section_192_final_no_save_release_ready_count"]
            == 1
        )
        assert no_save_batch_row["actual"]["durable_executor_open_allowed_count"] == 1
        assert no_save_batch_row["actual"]["durable_executor_opened_count"] == 1
        assert (
            no_save_batch_row["actual"]["durable_authoring_command_allowed_count"]
            == 1
        )
        assert (
            no_save_batch_row["actual"]["durable_authoring_command_dispatched_count"]
            == 1
        )
        assert (
            no_save_batch_row["actual"]["durable_authoring_command_executed_count"]
            == 1
        )
        assert (
            no_save_batch_row["actual"]["durable_authoring_command_completed_count"]
            == 1
        )
        assert no_save_batch_row["actual"]["final_no_save_release_ready_count"] == 1
        assert no_save_batch_row["actual"]["durable_authoring_enabled_count"] == 1
        assert no_save_batch_row["actual"]["durable_authoring_allowed_count"] == 0
        assert no_save_batch_row["actual"]["final_durable_release_ready_count"] == 0
        assert no_save_batch_row["actual"]["asset_write_performed_count"] == 0
        assert no_save_batch_row["actual"]["package_dirty_marked_count"] == 0
        assert no_save_batch_row["actual"]["save_delete_rename_allowed_count"] == 0
        assert no_save_batch_row["actual"]["save_asset_allowed_count"] == 0
        assert no_save_batch_row["actual"]["delete_asset_allowed_count"] == 0
        assert no_save_batch_row["actual"]["rename_asset_allowed_count"] == 0
        ...
        save_gate_open_admission_row = find_row(
            report,
            "durable_executor_authoring_save_gate_open_admission_batch",
        )
        assert save_gate_open_admission_row["status"] == "passed"
        assert (
            save_gate_open_admission_row["actual"][
        ...
        assert (
            save_gate_open_admission_row["actual"][
                "section_193_200_summary_schema_matches_count"
            ]
            == 1
        )
        assert (
            save_gate_open_admission_row["actual"][
                "section_193_200_summary_passed_count"
            ]
            == 1
        )
        assert (
            save_gate_open_admission_row["actual"][
                "section_193_200_save_gate_preflight_ready_count"
            ]
            == 1
        )
        assert (
            save_gate_open_admission_row["actual"][
                "section_193_200_save_gate_still_closed_count"
            ]
            == 1
        )
        assert (
        ...
        assert (
            save_gate_open_admission_row["actual"]["save_gate_open_allowed_count"]
            == 1
        )
        assert save_gate_open_admission_row["actual"]["save_gate_opened_count"] == 1
        assert (
            save_gate_open_admission_row["actual"][
        ...
        assert (
            save_gate_open_admission_row["actual"]["save_command_admitted_count"]
            == 1
        )
        assert (
            save_gate_open_admission_row["actual"][
        ...
        assert (
            save_gate_open_admission_row["actual"]["durable_authoring_enabled_count"]
            == 1
        )
        assert (
            save_gate_open_admission_row["actual"]["durable_executor_opened_count"]
            == 1
        )
        assert (
            save_gate_open_admission_row["actual"][
                "durable_authoring_save_gate_preflight_ready_count"
            ]
            == 1
        )
        assert (
        ...
        assert (
            save_gate_open_admission_row["actual"]["asset_write_performed_count"]
            == 0
        )
        assert (
            save_gate_open_admission_row["actual"]["package_dirty_marked_count"]
            == 0
        )
        assert (
            save_gate_open_admission_row["actual"][
        ...
        assert (
            save_gate_open_admission_row["actual"]["save_command_executed_count"]
            == 0
        )
        assert save_gate_open_admission_row["actual"]["save_true_allowed_count"] == 0
        assert save_gate_open_admission_row["actual"]["save_asset_allowed_count"] == 0
        assert (
            save_gate_open_admission_row["actual"]["compile_save_allowed_count"]
            == 0
        )
        assert (
            save_gate_open_admission_row["actual"][
        ...
        assert save_gate_open_admission_row["actual"]["delete_asset_allowed_count"] == 0
        assert save_gate_open_admission_row["actual"]["rename_asset_allowed_count"] == 0
        assert (
            save_gate_open_admission_row["actual"][
        ...
        assert (
            save_gate_open_admission_row["actual"]["live_command_dispatched_count"]
            == 0
        )
        ...
        live_save_stability_row = find_row(
            report,
            "durable_executor_authoring_live_save_stability_batch",
        )
        assert live_save_stability_row["status"] == "passed"
        expected_stability_one_counts = (
            "durable_requested_executor_authoring_live_save_stability_batch_count",
            "section_217_224_summary_schema_matches_count",
            "section_217_224_summary_passed_count",
            "section_217_224_actual_save_ready_count",
            "section_217_224_delete_rename_closed_count",
            "stability_result_schema_matches_count",
            "target_path_matches_count",
            "target_directory_matches_count",
            "compile_api_fixed_count",
            "legacy_compile_helper_mismatch_documented_count",
            "partial_save_recovery_verified_count",
            "idempotent_resave_verified_count",
            "save_readback_schema_strengthened_count",
            "dirty_package_stability_verified_count",
            "production_path_untouched_count",
            "delete_rename_cleanup_still_gated_count",
            "stability_has_no_error_count",
            "durable_authoring_enabled_count",
            "durable_executor_opened_count",
            "durable_authoring_allowed_count",
            "save_gate_open_allowed_count",
        ...
        for key in expected_stability_one_counts:
            assert live_save_stability_row["actual"][key] == 1, key
        expected_stability_zero_counts = (
        ...
        live_actor_bp_preflight_row = find_row(
            report,
            "durable_executor_authoring_live_actor_bp_authoring_preflight_batch",
        )
        assert live_actor_bp_preflight_row["status"] == "passed"
        expected_live_actor_one_counts = (
            "durable_requested_executor_authoring_live_actor_bp_authoring_preflight_batch_count",
            "section_249_256_summary_schema_matches_count",
            "section_249_256_summary_passed_count",
            "section_249_256_actor_bp_expansion_dry_run_ready_count",
            "section_249_256_actor_bp_mutation_outputs_closed_count",
            "result_schema_matches_count",
            "live_actor_bp_command_envelope_scoped_count",
            "live_actor_bp_read_only_target_preflight_ready_count",
            "live_actor_bp_mutation_sequence_planned_count",
            "live_actor_bp_compile_save_ordering_verified_count",
            "live_actor_bp_rollback_boundary_revalidated_count",
            "live_actor_bp_readback_evidence_plan_ready_count",
            "live_actor_bp_final_checkpoint_required_count",
        ...
        for key in expected_live_actor_one_counts:
            assert live_actor_bp_preflight_row["actual"][key] == 1, key
        expected_live_actor_zero_counts = (
            "variable_add_command_dispatched_count",
            "variable_add_command_executed_count",
            "component_add_command_dispatched_count",
            "component_add_command_executed_count",
        ...
        for key in expected_live_actor_zero_counts:
            assert live_actor_bp_preflight_row["actual"][key] == 0, key
        actual_actor_bp_row = find_row(
            report,
            "durable_executor_authoring_live_actor_bp_actual_authoring_batch",
        )
        assert actual_actor_bp_row["status"] == "passed"
        expected_actual_actor_one_counts = (
            "durable_requested_executor_authoring_live_actor_bp_actual_authoring_batch_count",
            "section_257_264_summary_schema_matches_count",
            "section_257_264_summary_passed_count",
            "section_257_264_live_actor_bp_preflight_ready_count",
            "section_257_264_mutation_outputs_closed_count",
            "result_schema_matches_count",
            "actual_execution_checkpoint_satisfied_count",
            "target_scope_reconfirmed_count",
            "variable_authoring_executed_count",
            "component_authoring_executed_count",
            "default_authoring_executed_count",
        ...
        for key in expected_actual_actor_one_counts:
            assert actual_actor_bp_row["actual"][key] == 1, key
        expected_actual_actor_zero_counts = (
            "actual_live_actor_bp_authoring_requires_final_user_checkpoint_count",
        ...
        cleanup_delete_actual_row = find_row(
            report,
            "durable_executor_authoring_cleanup_delete_actual_execution_batch",
        )
        assert cleanup_delete_actual_row["status"] == "passed"
        expected_cleanup_delete_actual_one_counts = (
        ...
        for key in expected_cleanup_delete_actual_one_counts:
            assert cleanup_delete_actual_row["actual"][key] == 1, key
        expected_cleanup_delete_actual_zero_counts = (
            "cleanup_allowed_count",
            "cleanup_executed_count",
            "rename_asset_allowed_count",
            "rename_command_dispatched_count",
        ...
        post_delete_recreation_actual_row = find_row(
            report,
            "durable_executor_authoring_post_delete_recreation_actual_execution_batch",
        )
        assert post_delete_recreation_actual_row["status"] == "passed"
        expected_recreation_actual_one_counts = (
        ...
        for key in expected_recreation_actual_one_counts:
            assert post_delete_recreation_actual_row["actual"][key] == 1, key
        expected_recreation_actual_zero_counts = (
            "actor_bp_authoring_package_dirty_marked_count",
            "variable_add_command_dispatched_count",
            "variable_add_command_executed_count",
            "component_add_command_dispatched_count",
        ...
        post_recreation_readback_row = find_row(
            report,
            "durable_executor_authoring_post_recreation_actor_bp_readback_strengthening_batch",
        )
        assert post_recreation_readback_row["status"] == "passed"
        expected_readback_one_counts = (
        ...
        for key in expected_readback_one_counts:
            assert post_recreation_readback_row["actual"][key] == 1, key
        expected_readback_zero_counts = (
            "variable_add_command_dispatched_count",
            "variable_add_command_executed_count",
            "component_add_command_dispatched_count",
        ...
        for key in expected_readback_zero_counts:
            assert post_recreation_readback_row["actual"][key] == 0, key
        post_recreation_diagnostics_refresh_row = find_row(
            report,
            "durable_executor_authoring_post_recreation_function_diagnostics_refresh_batch",
        )
        assert post_recreation_diagnostics_refresh_row["status"] == "passed"
        expected_diagnostics_refresh_one_counts = (
        ...
        for key in expected_diagnostics_refresh_one_counts:
            assert post_recreation_diagnostics_refresh_row["actual"][key] == 1, key
        expected_diagnostics_refresh_zero_counts = (
            "diagnostics_command_dispatched_count",
            "diagnostics_command_executed_count",
            "graph_repair_command_dispatched_count",
            "graph_repair_command_executed_count",
        ...
        for key in expected_diagnostics_refresh_zero_counts:
            assert post_recreation_diagnostics_refresh_row["actual"][key] == 0, key
        broader_non_actor_dry_run_row = find_row(
            report,
            "durable_executor_authoring_broader_non_actor_blueprint_dry_run_batch",
        )
        assert broader_non_actor_dry_run_row["status"] == "passed"
        expected_broader_dry_run_one_counts = (
        ...
        for key in expected_broader_dry_run_one_counts:
            assert broader_non_actor_dry_run_row["actual"][key] == 1, key
        expected_broader_dry_run_zero_counts = (
        ...
        correct_project_live_route_row = find_row(
            report,
            "durable_executor_authoring_correct_project_live_mcp_route_preflight_batch",
        )
        assert correct_project_live_route_row["status"] == "passed"
        expected_correct_project_live_route_one_counts = (
        ...
        for key in expected_correct_project_live_route_one_counts:
            assert correct_project_live_route_row["actual"][key] == 1, key
        expected_correct_project_live_route_zero_counts = (
        ...
        user_widget_preflight_row = find_row(
            report,
            "durable_executor_authoring_user_widget_widget_tree_live_readonly_preflight_batch",
        )
        assert user_widget_preflight_row["status"] == "passed"
        expected_user_widget_preflight_one_counts = (
        ...
        for key in expected_user_widget_preflight_one_counts:
            assert user_widget_preflight_row["actual"][key] == 1, key
        expected_user_widget_preflight_zero_counts = (
        ...
        user_widget_actual_row = find_row(
            report,
            "durable_executor_authoring_user_widget_actual_asset_creation_checkpoint_batch",
        )
        assert user_widget_actual_row["status"] == "passed"
        expected_user_widget_actual_one_counts = (
        ...
        for key in expected_user_widget_actual_one_counts:
            assert user_widget_actual_row["actual"][key] == 1, key
        expected_user_widget_actual_zero_counts = (
        ...
        user_widget_hardening_row = find_row(
            report,
            "durable_executor_authoring_user_widget_widget_tree_umg_cpp_route_hardening_batch",
        )
        assert user_widget_hardening_row["status"] == "passed"
        expected_user_widget_hardening_one_counts = (
        ...
        for key in expected_user_widget_hardening_one_counts:
            assert user_widget_hardening_row["actual"][key] == 1, key
        expected_user_widget_hardening_zero_counts = (
            "live_command_dispatched_count",
            "live_command_executed_count",
            "widget_tree_mutation_command_dispatched_count",
            "widget_tree_mutation_command_executed_count",
        ...
        data_asset_row = find_row(
            report,
            "durable_executor_authoring_data_asset_default_readonly_preflight_batch",
        )
        assert data_asset_row["status"] == "passed"
        expected_data_asset_one_counts = (
            ...
            "data_asset_default_mutation_outputs_blocked_count",
        ...
        for key in expected_data_asset_one_counts:
            assert data_asset_row["actual"][key] == 1, key
        expected_data_asset_zero_counts = (
            "data_asset_blueprint_create_command_dispatched_count",
            "data_asset_blueprint_create_command_executed_count",
        ...
        for key in expected_bfl_dry_run_one_counts:
            assert bfl_dry_run_row["actual"][key] == 1, key
        expected_bfl_dry_run_zero_counts = (
        ...
        for key in expected_bfl_dry_run_zero_counts:
            assert bfl_dry_run_row["actual"][key] == 0, key
        non_actor_actual_checkpoint_row = find_row(
            report,
            "durable_executor_authoring_non_actor_actual_temp_checkpoint_bridge_blocker_batch",
        )
        assert non_actor_actual_checkpoint_row["status"] == "passed"
        expected_non_actor_actual_checkpoint_one_counts = (
        ...
        for key in expected_non_actor_actual_checkpoint_one_counts:
            assert non_actor_actual_checkpoint_row["actual"][key] == 1, key
        expected_non_actor_actual_checkpoint_zero_counts = (
            "correct_workspace_bridge_started_count",
            "correct_workspace_bridge_verified_count",
        ...
        for key in expected_non_actor_actual_checkpoint_zero_counts:
            assert non_actor_actual_checkpoint_row["actual"][key] == 0, key
        bridge_takeover_handoff_row = find_row(
            report,
            "durable_executor_authoring_correct_workspace_bridge_takeover_handoff_batch",
        )
        assert bridge_takeover_handoff_row["status"] == "passed"
        expected_bridge_takeover_handoff_one_counts = (
        ...
        for key in expected_bridge_takeover_handoff_one_counts:
            assert bridge_takeover_handoff_row["actual"][key] == 1, key
        expected_bridge_takeover_handoff_zero_counts = (
        ...
        for key in expected_bridge_takeover_handoff_zero_counts:
            assert bridge_takeover_handoff_row["actual"][key] == 0, key
        bridge_takeover_envelope_row = find_row(
            report,
            "durable_executor_authoring_correct_workspace_bridge_takeover_execution_dry_run_envelope_batch",
        )
        assert bridge_takeover_envelope_row["status"] == "passed"
        expected_bridge_takeover_envelope_one_counts = (
        ...
        for key in expected_bridge_takeover_envelope_one_counts:
            assert bridge_takeover_envelope_row["actual"][key] == 1, key
        expected_bridge_takeover_envelope_zero_counts = (
            "process_termination_command_dispatched_count",
            "wrong_workspace_editor_stopped_count",
            "bridge_port_released_count",
            "correct_workspace_editor_launch_command_dispatched_count",
        ...
        verification_evidence_schema_row = find_row(
            report,
            "durable_executor_authoring_correct_workspace_bridge_verification_evidence_schema_batch",
        )
        assert verification_evidence_schema_row["status"] == "passed"
        expected_verification_evidence_schema_one_counts = (
        ...
        for key in expected_verification_evidence_schema_one_counts:
            assert verification_evidence_schema_row["actual"][key] == 1, key
        expected_verification_evidence_schema_zero_counts = (
        ...
        for key in expected_verification_evidence_schema_zero_counts:
            assert verification_evidence_schema_row["actual"][key] == 0, key
        verification_evidence_payload_dry_run_row = find_row(
            report,
            "durable_executor_authoring_correct_workspace_bridge_verification_evidence_payload_dry_run_batch",
        )
        assert verification_evidence_payload_dry_run_row["status"] == "passed"
        expected_verification_evidence_payload_dry_run_one_counts = (
        ...
        for key in expected_verification_evidence_payload_dry_run_one_counts:
            assert verification_evidence_payload_dry_run_row["actual"][key] == 1, key
        expected_verification_evidence_payload_dry_run_zero_counts = (
            "evidence_payload_received_count",
        ...
        for key in expected_verification_evidence_payload_dry_run_zero_counts:
            assert verification_evidence_payload_dry_run_row["actual"][key] == 0, key
        verification_evidence_validation_rule_dry_run_row = find_row(
            report,
            "durable_executor_authoring_correct_workspace_bridge_verification_evidence_validation_rule_dry_run_batch",
        )
        assert verification_evidence_validation_rule_dry_run_row["status"] == "passed"
        expected_verification_evidence_validation_rule_dry_run_one_counts = (
        ...
        for key in expected_verification_evidence_validation_rule_dry_run_one_counts:
            assert (
                verification_evidence_validation_rule_dry_run_row["actual"][key]
                == 1
            ), key
        expected_verification_evidence_validation_rule_dry_run_zero_counts = (
            "evidence_payload_received_count",
            "evidence_payload_ingested_count",
            "evidence_schema_validation_executed_count",
            "evidence_schema_validation_passed_count",
        ...
        for key in expected_verification_evidence_validation_rule_dry_run_zero_counts:
            assert (
                verification_evidence_validation_rule_dry_run_row["actual"][key]
                == 0
            ), key
        validation_execution_envelope_row = find_row(
            report,
            "durable_executor_authoring_correct_workspace_bridge_verification_evidence_validation_execution_dry_run_envelope_batch",
        )
        assert validation_execution_envelope_row["status"] == "passed"
        expected_validation_execution_envelope_one_counts = (
        ...
        for key in expected_validation_execution_envelope_one_counts:
            assert validation_execution_envelope_row["actual"][key] == 1, key
        expected_validation_execution_envelope_zero_counts = (
