...
ACTOR_LABEL_PREFIX = "MCP_Cubeless_ED_DitchAmountBlueprint"
...
AMOUNT_BLUEPRINT_SPECS = [
    {
        "name": "Sparse",
        "asset_name": "BP_Cubeless_ED_DitchAmount_Sparse",
        "graph_path": (
    ...
    {
        "name": "Normal",
        "asset_name": "BP_Cubeless_ED_DitchAmount_Normal",
        "graph_path": (
            "/Game/Cubeless/PCG/ElectricDreamsLearning/AmountPresets/"
    ...
    {
        "name": "Dense",
        "asset_name": "BP_Cubeless_ED_DitchAmount_Dense",
        "graph_path": (
            "/Game/Cubeless/PCG/ElectricDreamsLearning/AmountPresets/"
...
def spawn_validation_actor(spec, graph, index):
    ...
    actor = unreal.EditorLevelLibrary.spawn_actor_from_class(
        actor_class,
        unreal.Vector(13200 + index * 460, 0, 0),
...
def main():
    print("MCP_CUBELESS_ED_DITCH_AMOUNT_BLUEPRINTS_BUILD_BEGIN")
    ...
    print("MCP_CUBELESS_ED_DITCH_AMOUNT_BLUEPRINTS_BUILD_END")
